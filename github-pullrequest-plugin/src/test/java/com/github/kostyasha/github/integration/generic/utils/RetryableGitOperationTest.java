...
import com.github.kostyasha.github.integration.generic.utils.RetryableGitOperation.GitOperation;
...
public class RetryableGitOperationTest {
    ...
    private void whenExecuteOperation() {
        try {
            actualResult = RetryableGitOperation.execute(retries, 1L, mockOperation);
        } catch (Exception e) {
            thrownException = e;
        }
    }
