...
public class GitHubBranchRestrictionFilter extends GitHubBranchFilter {
    ...
    @Override
    public GitHubBranchCause check(GitHubBranchTrigger trigger, GHBranch remoteBranch, GitHubBranch localBranch,
            GitHubBranchRepository localRepo, LoggingTaskListenerWrapper pollingLog) {
    ...
    @Extension
    public static class Descriptor extends GitHubBranchFilterDescriptor {
        @Override
