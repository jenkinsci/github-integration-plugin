...
public class GitHubBranchCommitMessageEvent extends GitHubBranchCommitEvent {
    private static final String DISPLAY_NAME = "Commit Message Pattern";

    private static final String LINE_SEPARATOR = System.lineSeparator();
    private static final Logger LOGGER = LoggerFactory.getLogger(GitHubBranchCommitMessageEvent.class);
    ...
    public GitHubBranchCommitMessageEvent() {
    ...
    @Extension
    public static class DescriptorImpl extends GitHubBranchCommitEventDescriptor {
        @Override
